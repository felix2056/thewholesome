window.selectCallback = function(variant, selector) {
  ...
  timber.initializeComponents = function(){  
    ...
    // HOMEPAGE SLIDER
    // 
    $('#slider').owlCarousel({ loop: true, autoplay: true, autoplaySpeed: 1200, autoplayTimeout: 5000, autoplayHoverPause: false, nav:false, dots: true, items: 1 });
    ...
    if ($('#instafeed').length > 0){
      ...
      var feed = new Instafeed({
          ...
          limit: 15,
          sortBy: '' ,
          template: '<div class="item"><a title="{{caption}}" href="{{link}}"><img src="{{image}}" /></a></div>',
  ...
  timber.productPage = function (options) {    
    ...
    if (variant) {
      ...
      $productPrice.attr("data-currency", "");
    ...
    $("#wish-list").submit(function(e) {
      ...
      $.ajax({
        ...
        success:function(data, textStatus) {        
          $('.js-wish-list').empty().html('<a href=""><i class="fa fa-check-circle"></i> IN YOUR WISHLIST</a>');
        },
        error: function() {
