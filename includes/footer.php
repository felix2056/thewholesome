        ...
        <div class="Container">
            <div class="Footer__Inner">
                <div class="Footer__Block Footer__Block--text">
                    <h2 class="Footer__Title Heading u-h6">About the store</h2>
                    <div class="Footer__Content Rte">
                        <p>A Concept Store by Elsa's Wholesome Life.&nbsp;</p>
                        <p>A collection of items that I have designed, created or collaborations with creatives that I
                            adore.&nbsp;</p>
                    </div>
                </div>
                <div class="Footer__Block Footer__Block--links">
                    ...
                    <ul class="Linklist">
                        <li class="Linklist__Item">
                            <a href="/" class="Link Link--primary">Search</a>
                        </li>
                        <li class="Linklist__Item">
                            <a href="/collections" class="Link Link--primary">All Collections</a>
                        </li>
                        <li class="Linklist__Item">
                            <a href="http://www.elsaswholesomelife.com/" class="Link Link--primary">Blog</a>
                        </li>
                        <li class="Linklist__Item">
                            <a href="/pages/contact.php" class="Link Link--primary">Contact</a>
                        </li>
                        <li class="Linklist__Item">
                            <a href="/pages/returns.php" class="Link Link--primary">Returns</a>
                        </li>
                        <li class="Linklist__Item">
                            <a href="/pages/shipping.php" class="Link Link--primary">Shipping</a>
                        </li>
                    </ul>
                </div>
                <div class="Footer__Block Footer__Block--newsletter">
                    ...
                    <form method="post" action="/contact#footer-newsletter" id="footer-newsletter"
                        accept-charset="UTF-8" class="Footer__Newsletter Form"><input type="hidden" name="form_type"
            ...
            <div class="Footer__Aside">
                <div class="Footer__Copyright">
                    <a href="https://thewholesome.store" class="Footer__StoreName Heading u-h7 Link Link--secondary">©
                        The
                        Wholesome Store</a>
                    <p class="Footer__ThemeAuthor">Theme by Maestrooo | <a class="Link Link--primary" target="_blank"
                            rel="nofollow"
                ...
                <ul class="Footer__PaymentList HorizontalList">
                    ...
                    <li class="HorizontalList__Item"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" role="img"
                    ...
                    <li class="HorizontalList__Item"><svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg"
